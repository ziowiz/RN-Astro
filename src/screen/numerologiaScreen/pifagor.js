...
6: Получились все необходимые цифры для внесениях их в квадрат. 
  Наша матрица готова. Получем 9-квадратов в каждом по 9 цифр комбинаций. Используем базу данных всех комбинаций. Подставляем нужные числа в матрицу. База состоит из 89 книг по нумерологии. Взяты тезисы которые совпадают в каждой книге. Относитесь к информации как к развлечению. Книги признаны нумеролагами, но не проверялись научными исследованиями.
`;
